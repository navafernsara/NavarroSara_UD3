...
public class ControladorDelJugador : MonoBehaviour
{
    ...
    public Text finJuego1;
    public Text finJuego2;
    //Poner dos mensajes al finalizar el juego, uno con total pts
    ...
    public void Awake()
    {
        ...
        finJuego1.gameObject.SetActive(false);
        finJuego2.gameObject.SetActive(false);
    ...
    {
        marcador.text = "Puntos:" + contador + "/12";
    }
}
